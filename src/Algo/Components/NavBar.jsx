...
export default class NavigationBar extends React.Component {
    render() {
        const { changeAlgorithm, changeGrid, onClick, generateNewGrid, clearWeightsAndWalls } = this.props;
        ...
        return (
            ...
            >
                ...
                <Button variant="outline-light" onClick={onClick} style={{ margin: "auto 1%" }} id="visualize-btn">
                    Visualize
                ...
                <Nav.Item>{/* Blank space to seperate settings from algorithms */}</Nav.Item>
